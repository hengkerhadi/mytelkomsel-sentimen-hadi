...
# Membaca dataset
file_path = "mytelkomseltf_crawling.csv"
...
st.markdown('<div style="text-align: justify;"> Penelitian ini bertujuan untuk menganalisis perbandingan sentimen ulasan pengguna aplikasi mytelkomsel. Data sentimen didapat dari media sosial X (Twitter) dengan kriteria sebagai berikut\
            ...
            <br>3. Data merupakan postingan, repost, maupun komentar media sosial X dari bulan Januari 2025 hingga Maret 2025\
...
def main():
    ...
    with st.container():
        ...
        with col1:
            st.write("#### 1.")
            st.markdown('<div style="text-align: justify;"> Hasil analisis menunjukkan bahwa sentimen netral lebih mendominasi sebesar 932\
                        disusul dengan sentimen negatif sebesar 258 dan sentimen positif sebesar 187.\
        ...
        with col3:
            st.write("#### 3.")
            st.markdown('<div style="text-align: justify;"> Hasil akurasi Metode naive bayes yaitu 76% </div>', unsafe_allow_html=True) 
